...
from main import generate_recommendations, handler, MOCK_DATA
...
class TestGenerateRecommendations:
    ...
    def test_economie_notebooks_75_pct(self):
        ...
        assert rec["savings"] == expected, f"Attendu ${expected}, obtenu ${rec['savings']}"
...
class TestHandler:
    ...
    def test_handler_body_contient_champs_requis(self):
        ...
        for champ in ["success", "total_cost", "potential_savings", "savings_pct", "recommendations"]:
    ...
    def test_handler_pas_de_division_par_zero(self):
        ...
        main.MOCK_DATA = {
            "total_cost": 0,
            "cost_by_resource": {
                "notebooks": 0, "training": 0,
                "endpoints": 0, "storage": 0, "other": 0
            }
        }
        try:
            result = handler({}, None)
